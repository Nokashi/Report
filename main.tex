...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\documentclass[modern,hyperref,histinit,noindex,plain,newlogo]{unipi-thesis-eng}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%
\title{ST-Visions+: Extending the ST-Visions Library for Real Time Visual Analytics}
%%
%
%% -------------------------------------------------------------------
...
\authorNameEN{Paraschos Moraitis} 
%
%% -------------------------------------------------------------------
...
%
\thesisPlaceDate{Piraeus, November 2025}
%
%% -------------------------------------------------------------------
